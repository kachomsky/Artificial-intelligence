...
def main():
    ...
    print " from " + stationList[10].name + " L" + str(stationList[10].line) + " to " + stationList[
        11].name + " L" + str(stationList[11].line) + " : " + str(stationList[10].destinationDic[12]) + " minutes"
    # REAL time to go from PART-DIEU SERVIENT L3 to PART-DIEU L3
    print  " from " + stationList[11].name + " L" + str(stationList[11].line) + " to " + stationList[
        10].name + " L" + str(stationList[10].line) + " : " + str(stationList[11].destinationDic[11]) + " minutes"
    print"\n"
